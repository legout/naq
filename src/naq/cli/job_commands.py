    ...
    try:
        if action == "cancel":
            ...
            if result:
                ...
                console.print(
                    f"[yellow]Failed to pause job {job_id}. Job might not exist "
                    "or was already paused.[/yellow]"
                )
            ...
            if result:
                ...
                console.print(
                    f"[yellow]Failed to resume job {job_id}. Job might not exist "
                    "or was not paused.[/yellow]"
                )
            ...
            if result:
                ...
                console.print(
                    f"[yellow]Failed to reschedule job {job_id}. "
                    "Job might not exist.[/yellow]"
                )
    except Exception as e:
