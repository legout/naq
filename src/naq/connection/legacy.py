"""
Legacy connection functions for backward compatibility.
These functions will be gradually replaced by the new context managers.
"""
...
async def ensure_stream(
    ...
    try:
        ...
        await js.add_stream(
            ...
            retention=RetentionPolicy.WORK_QUEUE,  # Consume then delete
        )
