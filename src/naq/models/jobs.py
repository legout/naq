...
"""
Job model classes for NAQ job execution.

This module contains the core Job and JobResult classes that represent
jobs in the NAQ system and their execution results.
"""
...
from .enums import JOB_STATUS, RetryDelayType, VALID_RETRY_STRATEGIES
...
class JobResult(msgspec.Struct):
    ...
    This replaces the dictionary-based result representation with a typed
    structure for better performance and type safety.
    """
    ...
    def is_success(self) -> bool:
        ...
        return self.status == JOB_STATUS.COMPLETED.value
    
    def is_failure(self) -> bool:
        """Check if the job failed."""
        return self.status == JOB_STATUS.FAILED.value
...
class Job(msgspec.Struct):
    ...
    def get_results_manager(self, nats_url: str = DEFAULT_NATS_URL):
        """
