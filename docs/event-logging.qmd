...
| Variable | Default | Description |
|----------|---------|-------------|
| `NAQ_EVENT_LOGGER_BATCH_SIZE` | `100` | Number of events to buffer before flushing |
| `NAQ_EVENT_LOGGER_FLUSH_INTERVAL` | `5.0` | Seconds between automatic flushes |
| `NAQ_EVENT_LOGGER_MAX_BUFFER_SIZE` | `10000` | Maximum events to buffer (prevents memory issues) |
